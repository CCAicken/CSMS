...
public class VMajorScore implements java.io.Serializable {
	...
	/** full constructor */
	public VMajorScore(Integer collegeid, String collegename, Integer majorid,
			String majorname, Integer sportid, String sportname,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VMajorScore))
			return false;
		VMajorScore castOther = (VMajorScore) other;
