...
public class Expression {
	 ...
	 *            参数类型
	 */
	public void orLeftBraAnd(String paraName, String paraValue, Class valueClz) {
		if (leftbra == false) {
			if (count <= 0) {
				exp.append(" where ");
				exp.append("( " + paraName + " = ");
	 ...
	 *            参数类型
	 */
	public void orRightBraAnd(String paraName, String paraValue, Class valueClz) {
		if (leftbra == true) {
			if (count <= 0) {
				exp.append(" where ");
				exp.append(paraName + " = ");
	...
	public static void main(String[] args) {
		...
		exp.orLeftBraAnd("userid", "zhangjs", String.class);
