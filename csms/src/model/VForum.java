...
public class VForum implements java.io.Serializable {
	...
	/** minimal constructor */
	public VForum(Integer forumid, String title, Integer contentid,
			String textcontent, String author, String createtime) {
	...
	/** full constructor */
	public VForum(String id, Integer forumid, String title, Integer contentid,
			String textcontent, Integer picid, String picpath, String author,
			String createtime) {
		this.id = id;
		this.forumid = forumid;
		this.title = title;
	...
	public boolean equals(Object other) {
		...
		return ((this.getId() == castOther.getId()) || (this.getId() != null
				...
				castOther.getId())))
				&& ((this.getForumid() == castOther.getForumid()) || (this
						.getForumid() != null && castOther.getForumid() != null && this
						.getForumid().equals(castOther.getForumid())))
				...
				&& ((this.getPicpath() == castOther.getPicpath()) || (this
						.getPicpath() != null && castOther.getPicpath() != null && this
						.getPicpath().equals(castOther.getPicpath())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getForumid() == null ? 0 : this.getForumid().hashCode());
		result = 37 * result
		...
		result = 37 * result
				+ (getPicpath() == null ? 0 : this.getPicpath().hashCode());
		result = 37 * result
