...
public interface ScoreCollegeDAO {
	 ...
	 * string action 动作
	 */
	public List<VCollegeScore> getAllCollegeScore(String asction,String opretion);
	 ...
	 * @return List<ScoreCollege>数据集
	 */
	public List<VCollegeScore> getAllCollegeScoreBypage(String opretion,int pageSize,int currpage);
	/**
	 * 查询学院成绩
	 * @param opretion 条件
	 * @return
