		...
		<div class="layui-card-body">
			<div class="layui-row layui-form">
				<div class="layui-input-inline">
					<input type="text" placeholder="请输入查询条件" id="strwhere" autocomplete="off"
						class="layui-input">
				</div>
				<div class="layui-input-inline" style="margin-left: -10px;">
					<button type="button" class="layui-btn layui-btn" id="btn-search">查询</button>
				</div>
				<div class="layui-input-inline">
	...
	layui.use([ 'form', 'table' ], function() {
		...
		var form = layui.form, table = layui.table;
			table.render({
				...
				elem : '#basic-table',
				//height : 513,
				url : "arrangeview.action?op=load" // 数据接口
				,
				page : true // 开启分页
				,
				limits : [ 5, 10, 15 ],
