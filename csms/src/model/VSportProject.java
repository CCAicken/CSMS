...
public class VSportProject  implements java.io.Serializable {
   ...
   /** full constructor */
   public VSportProject(Integer id, Integer sportid, String sportname, String starttime, String endtime, String reportstart, String reportend, Integer proid, String proname, Integer scenelimit, Integer collegelimit, Integer totallimit, Integer protype, Integer currentnum, String record, String holderStu, String username, String agend, Integer roleid, String holderTea, String teausername, String teaagend, Integer tearoleid, Integer collegeid, String collegename, Integer classid, String classname, Integer majorid, String majorname, Integer recordsportid, String recordsportname) {
       this.id = id;
       this.sportid = sportid;
       this.sportname = sportname;
       this.starttime = starttime;
